...
_ResolvedTask = Literal[
    "generate", "embed", "classify", "score", "reward", "draft", "transcription"
]
...
class ModelConfig:
    ...
    def __post_init__(self) -> None:
        ...
        sliding_window_pattern = getattr(
            self.hf_text_config, "sliding_window_pattern", None
        )
        ...
        if quant_cfg is not None:
            ...
            for name in quantization_methods:
                ...
                if quantization_override is not None:
                    ...
                    if (
                        name in get_args(QuantizationMethods)
...
class CacheConfig:
    ...
    def _verify_prefix_caching(self) -> None:
        ...
        if (
            ...
            and self.prefix_caching_hash_algo
...
class ParallelConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            current_platform.device_type in ray_only_devices
...
class SpeculativeConfig:
    ...
    def __post_init__(self):
        ...
        if self.model is None and self.num_speculative_tokens is not None:
            ...
            if self.target_model_config and (
                ...
                == "deepseek_v3"
                or self.target_model_config.hf_text_config.model_type == "mimo"
            ):
    ...
    def _verify_args(self) -> None:
        ...
        if (
            self.acceptance_method != "rejection_sampler"
        ...
        if self.acceptance_method == "typical_acceptance_sampler" and (
            (
                ...
                and self.posterior_threshold < 0
            )
            or (self.posterior_alpha is not None and self.posterior_alpha < 0)
        ):
            raise ValueError(
...
class CompilationConfig:
        ...
        for k, v in self.inductor_passes.items():
            if not isinstance(v, str):
                ...
                self.inductor_compile_config[k] = (
                    v
                    if isinstance(v, InductorPass)
                    else CallableInductorPass(v)
                )
                continue
    ...
    def set_splitting_ops_for_v1(self):
        ...
        if self.splitting_ops and self.full_cuda_graph:
            raise ValueError(
                "full_cuda_graph cannot be used together with "
...
def get_layers_from_vllm_config(
    vllm_config: VllmConfig, layer_type: type[T]
) -> dict[str, T]:
    return {
        layer_name: layer
